...
- [MCP Servers](https://github.com/modelcontextprotocol/servers) - Official MCP reference implementations
- [awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code) - Curated resources

### Community Resources
- [GitButler Blog: Automate Your AI Workflows](https://blog.gitbutler.com/automate-your-ai-workflows-with-claude-code-hooks)
- [eesel AI: Claude Code Hooks Guide](https://www.eesel.ai/blog/hooks-in-claude-code)
- [Claude Skills Deep Dive](https://leehanchung.github.io/blogs/2025/10/26/claude-skills-deep-dive/)
- [ClaudeLog Mechanics](https://claudelog.com/mechanics/hooks/)

---

## How to Use This Research

1. **Start with [best-practices.md](./best-practices.md)** for high-level recommendations
2. **Read [hooks-reference.md](./hooks-reference.md)** to understand the trigger system
3. **Review [examples.md](./examples.md)** for implementation patterns
4. **Explore topic-specific docs** (subagents, MCP, skills) as needed
5. **Check [repositories.md](./repositories.md)** for real-world implementations

Each document includes:
- ✅ Practical examples with code
- ✅ Alignment with project principles (MINIMIZE, SEPARATE, VALIDATE, LEARN)
...
**Session ID**: claude/research-triggers-best-practices-011CUmR41GdHSE1X9DkuNeiu
**Branch**: claude/research-triggers-best-practices-011CUmR41GdHSE1X9DkuNeiu
