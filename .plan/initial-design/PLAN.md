...
```bash
# Hypothesis: Minimal .cursorrules (80 lines) performs 
...
# Note: Cursor auto-includes claude.md, so .cursorrules is the single
# config file to optimize
```
...
1. Test different .cursorrules sizes (30, 50, 80, 100 lines)
2. Find optimal minimal configuration
3. Validate each rule's contribution
4. Build the minimal core based on data

**Note**: Since Cursor auto-includes claude.md in .cursorrules, we focus on
optimizing a single tight config file (< 100 lines total).
